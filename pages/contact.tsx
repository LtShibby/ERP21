...
export default function Contact() {
  return (
    <Layout 
      ...
      description="Contact ERP21 for your recruitment needs. Email us at alkaff@erp21.com.sg or connect via WhatsApp for immediate assistance."
    >
      {/* Header */}
        ...
        <div className="page-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <a 
                href="mailto:alkaff@erp21.com.sg?subject=Resume Submission&body=Dear ERP21 Team,%0D%0A%0D%0APlease find my resume attached for your consideration for future opportunities.%0D%0A%0D%0ABest regards"
